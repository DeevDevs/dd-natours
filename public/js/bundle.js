...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.242806, 34.084205],
    // zoom: 8,
    // interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend map bounds to include this marker
...
var stripe = Stripe('pk_test_51KveasByVJnJHpaDJtQ3glxPACqIYjdCObnETgSvp2ISFY0Kz0s8shpHf3txPVQvodb0hsGhYc21MNp6j58vV29L00FgMHC9hk');
...
var bookTourBtn = document.getElementById('book-tour'); // const btnUpdateUserData = document.querySelector('.btn--save-user-data');
...
if (updateUserForm) {
  updateUserForm.addEventListener('submit', function (e) {
    e.preventDefault(); //however, to recreate the multipart form-data to then make an api call, we need to do the following

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]); // const data = Object.fromEntries(updates);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              updates = new FormData(updatePasswordForm);
              data = Object.fromEntries(updates); // console.log(data);
